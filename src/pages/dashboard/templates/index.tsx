    ...
    <>
      ...
      {profile?.role === 'super_admin' ? (
        <AdminView
          ...
          stagedBgms={bgm.stagedBgms}
          isBgmUploading={bgm.isBgmUploading}
          playingBgmId={bgm.playingBgmId}
          addStagedBgms={bgm.addStagedBgms}
          updateStagedBgm={bgm.updateStagedBgm}
          removeStagedBgm={bgm.removeStagedBgm}
          clearStagedBgms={bgm.clearStagedBgms}
